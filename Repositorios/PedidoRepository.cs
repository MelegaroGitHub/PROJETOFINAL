...
namespace Hamburgueria_Tarde.Repositorios
{
    public class PedidoRepository : BaseRepository
    {
        ...
        private Pedido ConverterEmObjeto(string registro)
        {
            ...
            pedido.Planos.Nome = ExtrairCampo("planosNome", registro);
            pedido.Planos.Preco = double.Parse(ExtrairCampo("planosPreco", registro));
            pedido.Contatos.Nome = ExtrairCampo("contatosNome", registro);
        ...
        private string PrepararRegistroCSV(Pedido pedido)
        {
            ...
            return $"id={id};clienteNome={pedido.Cliente.Nome};clienteEndereco={pedido.Cliente.Endereco};clienteTelefone={pedido.Cliente.Telefone};clienteEmail={pedido.Cliente.Email};hamburguerNome={pedido.Planos.Nome};hamburguerPreco={pedido.Planos.Preco};shakeNome={pedido.Contatos.Nome};dataPedido={pedido.DataPedido};precoTotal={pedido.PrecoTotal}\n";
        }
    }
}